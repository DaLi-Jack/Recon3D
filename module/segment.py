...
class SAM():
    ...
    def run(self, input_box, det_text, save_sam_path, use_inpainting):
        ...
        plt.axis('off')
        plt.savefig(os.path.join(save_sam_path, det_text+'_sam.png'), bbox_inches='tight')
        # plt.show()
        ...
        # save_vis_img.show()
        save_inpaint_path = save_sam_path.replace('sam', 'inpaint')
    ...
    def update(self, add_points, input_box, det_text, save_sam_path, use_inpainting):
